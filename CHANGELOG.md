...
- Fixed regex pattern to match and delete appsettings files with double extensions (e.g., `appsettings.Dev.json.br`, `appsettings.Development.json.gz`) which were previously not being detected and deleted
